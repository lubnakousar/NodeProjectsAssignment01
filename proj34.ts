 ...
 * */
let pizza_flavor: String[] = ["Chicken Tikka","Barbecue","Fajita","Maxican","Pasta","Butter Chicken"]
let i = 0;
for(i=0; i<pizza_flavor.length; i++)
{
    console.log(pizza_flavor[i])
}
for(i=0; i<pizza_flavor.length; i++){
    console.log("I like",pizza_flavor[i],"pizza.")
}
console.log("I like to pizza so much that I can bake almost all the flavours of pizza.")