...
//version 1
function make_album(artist_name: String, album_title: String, number_track?: number): {artist_name: String; album_title: String; number_track?: number}{
   const album = {
    artist_name,
    album_title,
    number_track,
...
function make_album2(artist_name2: String, album_title2: String, number_track2?: number): {artist_name2: String; album_title2: String; number_track2?: number}{
